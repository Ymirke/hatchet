...
1. [Automatic, Simple Task-Level Retries](./simple.mdx)

   - Configure a specific number of retries for each task in your workflow
...
2. [Manual Retries](./manual.mdx)
   - Web dashboard displays a list of all workflow and task runs, along with their status
   - Investigate failures, modify input data, and manually retry failed tasks or workflows
