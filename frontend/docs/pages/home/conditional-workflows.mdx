...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.waits.worker} block="create_a_workflow" />
  </Tabs.Tab>
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.waits.worker} block="add_base_task" />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snips.typescript.dag_match_condition.complex_workflow}
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.waits.worker} block="add_wait_for_sleep" />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snips.typescript.dag_match_condition.complex_workflow}
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.waits.worker} block="add_skip_on_event" />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snips.typescript.dag_match_condition.complex_workflow}
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.waits.worker} block="add_branching" />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snips.typescript.dag_match_condition.complex_workflow}
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
    <Snippet src={snips.python.waits.worker} block="add_wait_for_event" />
  </Tabs.Tab>
  <Tabs.Tab title="Typescript">
    <Snippet
      src={snips.typescript.dag_match_condition.complex_workflow}
...
<UniversalTabs items={["Python", "Typescript", "Go"]}>
  <Tabs.Tab title="Python">
<Snippet src={snips.python.waits.worker} block="add_sum" />
