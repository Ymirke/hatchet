...
export const TimeoutTs = {
  path: "src/v1/examples/with_timeouts/workflow.ts",
};
...
export const getStaticProps = ({}) =>
  getSnippets([TimeoutPy, TimeoutTs, TimeoutGo]);
...
<UniversalTabs items={['Python', 'Typescript']}>
  ...
  <Tabs.Tab>
  <GithubSnippet src={TimeoutTs} target="Execution Timeout" />
...
<UniversalTabs items={['Python', 'Typescript']}>
  ...
  <Tabs.Tab>
  <GithubSnippet src={TimeoutTs} target="Refresh Timeout" />
  </Tabs.Tab>
  <Tabs.Tab>
